...
from ._utility import wigner_seitz
from symclosestwannier.system.amn import Amn
from symclosestwannier.system.eig import Eig
from symclosestwannier.system.win import Win
...
class Berry(dict):
    ...
    # ==================================================
    def __init__(self, topdir, seedname, nnkp, mmn, win, Uk):
        """
