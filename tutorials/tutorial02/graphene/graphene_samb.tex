...
\quad $\bm{a}_3=\begin{pmatrix} 6.0 \cdot 10^{-14} & 1.1 \cdot 10^{-13} & 1000.0 \end{pmatrix}$
...
\caption{High-symmetry line: $\Gamma$-M-K-$\Gamma$.}
 \\
 \hline \hline
...
\multicolumn{6}{r}{} \\ \endlastfoot
 ...
 & $\Gamma$ & $\begin{pmatrix} 0 & 0 & 0 \end{pmatrix}$ & K & $\begin{pmatrix} \frac{1}{3} & \frac{1}{3} & 0 \end{pmatrix}$ & M & $\begin{pmatrix} \frac{1}{2} & 0 & 0 \end{pmatrix}$ \\
\end{longtable}
\end{center}
...
& b$_{30}$ & C$_{1}$ & C$_{1}$ & 6 & 1 & $\begin{pmatrix} 2 & 0 & 0 \end{pmatrix}@\begin{pmatrix} \frac{2}{3} & \frac{1}{3} & 0 \end{pmatrix}$ & [7,-9,15,-24] \\
\end{longtable}
\end{center}
